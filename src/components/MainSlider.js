                            ...
                            <div className="row">
                                <div className="col-xl-6 col-lg-7 col-md-11">
                                    <div className="slider-content">
                                        ...
                                        <a href="/#" className="btn btn-style-two" data-animation="fadeInUp" data-delay=".8s">COMING SOON</a>
                                        <a href="/#" className="btn btn-style-two" data-animation="fadeInUp" data-delay=".8s">Whitepaper</a>
                                        <a href="/#" className="btn btn-style-two" data-animation="fadeInUp" data-delay=".8s">Donate</a>
                                    </div>
                                </div>
                            </div>
                        </div>
