            ...
            <section className="mission-area">
                ...
                <div className="row align-items-center">
                    ...
                    <div className="section-title mb-20 mint_title mt-30 text-center">
                        <h2 className="title"><span>Samurai Inu</span> NFT-Gaming</h2>
                    ...
                    <div className="mission-content text-center c_buy_d">
                        <p>You can purchase our Samurai Inu Token on <span>Uniswap</span> and <span>exchanges</span>. Check <a target="_balnk" rel="noreferrer" href="https://coinmarketcap.com/de/currencies/Samuraiinu/ ">coinmarketcap</a>.
We will lead this huge Project to create massive Value in the Cryptocurrency Space. Soon we are selling our NFTs join us on discord:
                        ...
                        <li><a href="https://app.uniswap.org/#/swap?inputCurrency=0x000" target="_blank" rel="noreferrer"><img src="assets/img/images/b.png" alt="Nft" /></a></li>
                        </ul> */}

                        <a className="btn mt-4 d-flex align-items-center w-50 m-auto nft-btn" target="_blank" rel="noreferrer" href='https://discord.com/invite/SamuraiInuERC'><i className="fab fa-discord mr-3" style={{ fontSize:'40px', marginRight:'10px'}}></i> <span>Join Discord Now</span></a>
                        <a className="btn mt-4 d-block w-50 m-auto nft-btn" href="https://nft.SamuraiInuERC.com">Go to NFT Page</a>
                    </div>
                    </div>
                </div>
                </div>
