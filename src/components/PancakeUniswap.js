...
ETH Wallet or BSC Wallet. When you purchasing Katana on Uniswap or Pancake Swap.</p>
                        ...
                        <div className="col-lg-6 col-sm-12 text-center">
                            <p className='text-dark' style={{ fontSize: '18px', fontWeight: 800}}><a href='https://app.uniswap.org/#/swap?inputCurrency=ETH&outputCurrency=0x000&chain=mainnet' target='_blank' rel='noreferrer'>Uniswap</a> </p>
