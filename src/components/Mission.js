                ...
                <div className="container">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="mission-content">
                            ...
                            <p>
                            Games are our Passion. That's why we developed Katana Inu, to create a Platform that promotes 
Innovation in the gaming Sector. Katana Inu is a battle royale & play2earn multiplayer game with NFT-skins in an interactive open world map. We have effectively combined the Sectors of gaming and Blockchain Technology. We are managing this major Project with a Team of experienced Entrepreneurs from Germany. The Plan is to create massive Value in the Crypto Space.
<br/><br/>
Our Vision is to develop modern High-End Games. Through this development, we aim to increase the Value of Katana Inu for the Community. The Games will be integrated into an NFT digital Art Marketplace via a decentralized Ecosystem. All NFT Skins will be available to use In-Game or there is the Option to sell them for Ethereum or the Katana Inu Token.For more Information, you can read the Whitepaper 
                            </p>
                        </div>
                    </div>
                    </div>
