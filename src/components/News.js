                ...
                <div className='container'>
                    <div className="row justify-content-center mt-5">
                        <div className="col-xl-8 col-lg-9">
                            ...
                            <h2 className="title">Latest News <span> About SamuraiInuERC</span></h2>
                            <p className="timeline-desc text-dark">Keep yourself up to date with all the news concerning Project SamuraiInuERC.</p>
                            </div>
                        </div>
                    </div>
